...
6. server.py — a Flask API over the same code, for the interactive frontend
7. index.html — the frontend: raw data, the fitted model, calibration, a live predictor, the inversion tool, and 
8. several 3D visualizations, all by real API calls 
